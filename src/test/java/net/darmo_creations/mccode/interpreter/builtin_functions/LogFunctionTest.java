...
class LogFunctionTest extends BuiltinFunctionTest<LogFunction> {
  @Test
  void getName() {
    assertEquals("log", this.function.getName());
  }
  ...
  void apply(double d) {
    ...
    assertEquals(Math.log(d), this.function.apply(this.p.getScope()));
  }
