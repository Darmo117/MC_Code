...
class AsinFunctionTest extends BuiltinFunctionTest<AsinFunction> {
  @Test
  void getName() {
    assertEquals("asin", this.function.getName());
  }
  ...
  void apply(double d) {
    ...
    assertEquals(Math.asin(d), this.function.apply(this.p.getScope()));
  }
