...
class AbsFunctionTest extends BuiltinFunctionTest<AbsFunction> {
  @Test
  void getName() {
    assertEquals("abs", this.function.getName());
  }
  ...
  void apply(double d) {
    ...
    assertEquals(Math.abs(d), this.function.apply(this.p.getScope()));
  }
