...
class CosFunctionTest extends BuiltinFunctionTest<CosFunction> {
  @Test
  void getName() {
    assertEquals("cos", this.function.getName());
  }
  ...
  void apply(double d) {
    ...
    assertEquals(Math.cos(d), this.function.apply(this.p.getScope()));
  }
