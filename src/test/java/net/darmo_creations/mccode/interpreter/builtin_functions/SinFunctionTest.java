...
class SinFunctionTest extends BuiltinFunctionTest<SinFunction> {
  @Test
  void getName() {
    assertEquals("sin", this.function.getName());
  }
  ...
  void apply(double d) {
    ...
    assertEquals(Math.sin(d), this.function.apply(this.p.getScope()));
  }
