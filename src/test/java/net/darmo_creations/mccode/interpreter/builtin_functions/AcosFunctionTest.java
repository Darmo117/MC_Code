...
class AcosFunctionTest extends BuiltinFunctionTest<AcosFunction> {
  @Test
  void getName() {
    assertEquals("acos", this.function.getName());
  }
  ...
  void apply(double d) {
    ...
    assertEquals(Math.acos(d), this.function.apply(this.p.getScope()));
  }
