...
class ScopeTest {
  ...
  void setUp() {
    ...
    this.s.declareVariable(new Variable("var", false, false, false, true, 1));
  ...
  @Test
  void getVariable() {
    assertEquals(1, this.s.getVariable("var", false));
  }
  ...
  @Test
  void setVariable() {
    this.s.setVariable("var", 2, false);
    assertEquals(2, this.s.getVariable("var", false));
  }

  @Test
  void setConstantError() {
    this.s.declareVariable(new Variable("a", false, false, true, true, 1));
  ...
  void declareVariable() {
    ...
    assertEquals(1, this.s.getVariable("a", false));
  }
  ...
  void deleteVariableError() {
    this.s.declareVariable(new Variable("a", false, false, false, false, 1));
  ...
  void getVariableFromSubScope() {
    assertEquals(1, this.sub.getVariable("var", false));
  }
  ...
  void setVariableFromSubScope() {
    this.sub.setVariable("var", 2, false);
    assertEquals(2, this.sub.getVariable("var", false));
  }
  ...
  void setVariableFromOutsideFromSubScope() {
    ...
    assertEquals(2, this.sub.getVariable("a", true));
  }
  ...
  void declareVariableFromSubScope() {
    // Declare variable in parent scope
    this.sub.declareVariable(new Variable("a", false, false, false, true, 1));
    assertEquals(1, this.sub.getVariable("a", false));
    assertFalse(this.s.isVariableDefined("a"));
  }
  ...
  void writeToNBT() {
    ...
    vars.appendTag(new Variable("var", false, false, false, true, 1).writeToNBT());
