...
class FloatTypeTest extends TypeTest<FloatType> {
  ...
  public static Stream<Arguments> provideArgsForApplyBinaryOperator() {
    return Stream.of(
        Arguments.of(BinaryOperator.PLUS, 1.0, 1, 2.0),
        ...
        Arguments.of(BinaryOperator.PLUS, -1.0, "a", "-1.0a"),
        Arguments.of(BinaryOperator.PLUS, 0.0, 1, 1.0),
        ...
        Arguments.of(BinaryOperator.SUB, 1.0, 1, 0.0),
        ...
        Arguments.of(BinaryOperator.SUB, 0.0, 1, -1.0),
        ...
        Arguments.of(BinaryOperator.MUL, 1.0, 2, 2.0),
        ...
        Arguments.of(BinaryOperator.MUL, 0.0, 1, 0.0),
        ...
        Arguments.of(BinaryOperator.DIV, 1.0, 2, 0.5),
        Arguments.of(BinaryOperator.DIV, 1.0, 2.0, 0.5),
        Arguments.of(BinaryOperator.DIV, 1.0, true, 1.0),
        Arguments.of(BinaryOperator.DIV, 0.0, 1, 0.0),
        Arguments.of(BinaryOperator.DIV, 0.0, 1.0, 0.0),
        Arguments.of(BinaryOperator.DIV, 0.0, true, 0.0),

        Arguments.of(BinaryOperator.INT_DIV, 1.0, 2, 0),
        Arguments.of(BinaryOperator.INT_DIV, 1.0, 2.0, 0),
        Arguments.of(BinaryOperator.INT_DIV, 1.0, true, 1),
        Arguments.of(BinaryOperator.INT_DIV, 0.0, 1, 0),
        Arguments.of(BinaryOperator.INT_DIV, 0.0, 1.0, 0),
        Arguments.of(BinaryOperator.INT_DIV, 0.0, true, 0),

        Arguments.of(BinaryOperator.MOD, 1.0, 2, 1.0),
        ...
        Arguments.of(BinaryOperator.MOD, 0.0, 1, 0.0),
        ...
        Arguments.of(BinaryOperator.EQUAL, 1.0, 1, true),
        ...
        Arguments.of(BinaryOperator.NOT_EQUAL, 1.0, 1, false),
        ...
        Arguments.of(BinaryOperator.GT, 1.0, 1, false),
        ...
        Arguments.of(BinaryOperator.GT, 0.0, 1, false),
        ...
        Arguments.of(BinaryOperator.GE, 1.0, 1, true),
        ...
        Arguments.of(BinaryOperator.GE, 0.0, 1, false),
        ...
        Arguments.of(BinaryOperator.LT, 1.0, 1, false),
        ...
        Arguments.of(BinaryOperator.LT, 0.0, 1, true),
        ...
        Arguments.of(BinaryOperator.LE, 1.0, 1, true),
        ...
        Arguments.of(BinaryOperator.LE, 0.0, 1, true),
  ...
  public static Stream<Arguments> provideArgsForApplyBinaryOperatorError() {
    return Stream.of(
        ...
        Arguments.of(BinaryOperator.IN, 1.0, 1, UnsupportedOperatorException.class),
        ...
        Arguments.of(BinaryOperator.NOT_IN, 1.0, 1, UnsupportedOperatorException.class),
        ...
        Arguments.of(BinaryOperator.GET_ITEM, 1.0, 1, UnsupportedOperatorException.class),
        ...
        Arguments.of(BinaryOperator.DEL_ITEM, 1.0, 1, UnsupportedOperatorException.class),
  ...
  static Stream<Arguments> provideArgsForApplyTernaryOperatorError() {
    return Stream.of(
        ...
        Arguments.of(TernaryOperator.SET_ITEM, 1.0, 1, true, UnsupportedOperatorException.class),
