...
class SetTypeTest extends TypeTest<SetType> {
  ...
  void getUndefinedPropertyError() {
    assertThrows(EvaluationException.class, () -> this.typeInstance.getPropertyValue(this.p.getScope(), new MCSet(), "a"));
  }

  @Test
  void setUndefinedPropertyError() {
    assertThrows(EvaluationException.class, () -> this.typeInstance.setPropertyValue(this.p.getScope(), new MCSet(), "a", true));
  }
  ...
  @Test
  void iteration() {
    MCSet set = new MCSet(Arrays.asList(1L, 2L, "a", new Position(1, 2, 3)));
...
//        Arguments.of(BinaryOperator.EQUAL, new MCSet(Arrays.asList(1L, 2L)), Items.STICK, false, false), // FIXME not initialized
        ...
        Arguments.of(BinaryOperator.EQUAL, new MCSet(Collections.singletonList(0L)), new Position(0, 0, 0), false, false),
...
//        Arguments.of(BinaryOperator.NOT_EQUAL, new MCSet(Arrays.asList(1L, 2L)), Items.STICK, true, false), // FIXME not initialized
        ...
        Arguments.of(BinaryOperator.NOT_EQUAL, new MCSet(Collections.singletonList(0L)), new Position(0, 0, 0), true, false),
...
//        Arguments.of(BinaryOperator.IN, new MCSet(Collections.singletonList(Blocks.STONE)), Blocks.STONE, true, false), // FIXME not initialized
        ...
        Arguments.of(BinaryOperator.IN, new MCSet(Collections.singletonList(new Position(0, 0, 0))), new Position(0, 0, 0), true, false),
...
//        Arguments.of(BinaryOperator.NOT_IN, new MCSet(Collections.singletonList(Blocks.STONE)), Blocks.STONE, false, false), // FIXME not initialized
        ...
        Arguments.of(BinaryOperator.NOT_IN, new MCSet(Collections.singletonList(new Position(0, 0, 0))), new Position(0, 0, 0), false, false),
...
//        Arguments.of(BinaryOperator.PLUS, new MCList(), new Block(Material.AIR), UnsupportedOperatorException.class), // FIXME not initialized
        ...
        Arguments.of(BinaryOperator.PLUS, new MCSet(), new Position(0, 0, 0), UnsupportedOperatorException.class),
...
//        Arguments.of(BinaryOperator.SUB, new MCSet(), new Block(Material.AIR), UnsupportedOperatorException.class), // FIXME not initialized
        ...
        Arguments.of(BinaryOperator.SUB, new MCSet(), new Position(0, 0, 0), UnsupportedOperatorException.class),
...
//        Arguments.of(BinaryOperator.DIV, new MCSet(), new Block(Material.AIR), UnsupportedOperatorException.class), // FIXME not initialized
        ...
        Arguments.of(BinaryOperator.DIV, new MCSet(), new Position(0, 0, 0), UnsupportedOperatorException.class),
...
//        Arguments.of(BinaryOperator.INT_DIV, new MCSet(), new Block(Material.AIR), UnsupportedOperatorException.class), // FIXME not initialized
        ...
        Arguments.of(BinaryOperator.INT_DIV, new MCSet(), new Position(0, 0, 0), UnsupportedOperatorException.class),
...
//        Arguments.of(BinaryOperator.MOD, new MCList(), new Block(Material.AIR), UnsupportedOperatorException.class), // FIXME not initialized
        ...
        Arguments.of(BinaryOperator.MOD, new MCSet(), new Position(0, 0, 0), UnsupportedOperatorException.class),
...
//        Arguments.of(BinaryOperator.POW, new MCSet(), new Block(Material.AIR), UnsupportedOperatorException.class), // FIXME not initialized
        ...
        Arguments.of(BinaryOperator.POW, new MCSet(), new Position(0, 0, 0), UnsupportedOperatorException.class),
...
//        Arguments.of(BinaryOperator.GT, new MCSet(), new Block(Material.AIR), UnsupportedOperatorException.class), // FIXME not initialized
        ...
        Arguments.of(BinaryOperator.GT, new MCSet(), new Position(0, 0, 0), UnsupportedOperatorException.class),
...
//        Arguments.of(BinaryOperator.GE, new MCSet(), new Block(Material.AIR), UnsupportedOperatorException.class), // FIXME not initialized
        ...
        Arguments.of(BinaryOperator.GE, new MCSet(), new Position(0, 0, 0), UnsupportedOperatorException.class),
...
//        Arguments.of(BinaryOperator.LT, new MCSet(), new Block(Material.AIR), UnsupportedOperatorException.class), // FIXME not initialized
        ...
        Arguments.of(BinaryOperator.LT, new MCSet(), new Position(0, 0, 0), UnsupportedOperatorException.class),
...
//        Arguments.of(BinaryOperator.LE, new MCSet(), new Block(Material.AIR), UnsupportedOperatorException.class), // FIXME not initialized
        ...
        Arguments.of(BinaryOperator.LE, new MCSet(), new Position(0, 0, 0), UnsupportedOperatorException.class),
...
//        Arguments.of(BinaryOperator.GET_ITEM, new MCSet(), new Block(Material.AIR), UnsupportedOperatorException.class), // FIXME not initialized
        ...
        Arguments.of(BinaryOperator.GET_ITEM, new MCSet(), new Position(0, 0, 0), UnsupportedOperatorException.class),
...
//        Arguments.of(BinaryOperator.DEL_ITEM, new MCSet(), new Block(Material.AIR), UnsupportedOperatorException.class), // FIXME not initialized
        ...
        Arguments.of(BinaryOperator.DEL_ITEM, new MCSet(), new Position(0, 0, 0), UnsupportedOperatorException.class),
  ...
  static Stream<Arguments> provideArgsForApplyTernaryOperatorError() {
    return Stream.of(
        ...
        Arguments.of(TernaryOperator.SET_ITEM, new MCSet(), new Position(0, 0, 0), true, UnsupportedOperatorException.class),
