...
class BooleanTypeTest extends TypeTest<BooleanType> {
  ...
  public static Stream<Arguments> provideArgsForApplyUnaryOperator() {
    return Stream.of(
        Arguments.of(UnaryOperator.MINUS, true, -1),
        Arguments.of(UnaryOperator.MINUS, false, 0),
  ...
  public static Stream<Arguments> provideArgsForApplyBinaryOperator() {
    return Stream.of(
        Arguments.of(BinaryOperator.PLUS, true, 1, 2),
        Arguments.of(BinaryOperator.PLUS, true, 1.0, 2.0),
        Arguments.of(BinaryOperator.PLUS, true, true, 2),
        Arguments.of(BinaryOperator.PLUS, true, false, 1),
        Arguments.of(BinaryOperator.PLUS, true, "a", "truea"),
        Arguments.of(BinaryOperator.PLUS, false, 1, 1),
        Arguments.of(BinaryOperator.PLUS, false, 1.0, 1.0),
        Arguments.of(BinaryOperator.PLUS, false, true, 1),
        Arguments.of(BinaryOperator.PLUS, false, false, 0),
        Arguments.of(BinaryOperator.PLUS, false, "a", "falsea"),

        Arguments.of(BinaryOperator.SUB, true, 1, 0),
        Arguments.of(BinaryOperator.SUB, true, 1.0, 0.0),
        Arguments.of(BinaryOperator.SUB, true, true, 0),
        Arguments.of(BinaryOperator.SUB, true, false, 1),
        Arguments.of(BinaryOperator.SUB, false, 1, -1),
        Arguments.of(BinaryOperator.SUB, false, 1.0, -1.0),
        Arguments.of(BinaryOperator.SUB, false, true, -1),
        Arguments.of(BinaryOperator.SUB, false, false, 0),

        Arguments.of(BinaryOperator.MUL, true, 2, 2),
        Arguments.of(BinaryOperator.MUL, true, 2.0, 2.0),
        Arguments.of(BinaryOperator.MUL, true, true, 1),
        Arguments.of(BinaryOperator.MUL, true, false, 0),
        Arguments.of(BinaryOperator.MUL, false, 1, 0),
        Arguments.of(BinaryOperator.MUL, false, 1.0, 0.0),
        Arguments.of(BinaryOperator.MUL, false, true, 0),
        Arguments.of(BinaryOperator.MUL, false, false, 0),
        ...
        Arguments.of(BinaryOperator.DIV, true, 2, 0.5),
        Arguments.of(BinaryOperator.DIV, true, 2.0, 0.5),
        Arguments.of(BinaryOperator.DIV, true, true, 1.0),
        Arguments.of(BinaryOperator.DIV, false, 1, 0.0),
        Arguments.of(BinaryOperator.DIV, false, 1.0, 0.0),
        Arguments.of(BinaryOperator.DIV, false, true, 0.0),

        Arguments.of(BinaryOperator.INT_DIV, true, 2, 0),
        Arguments.of(BinaryOperator.INT_DIV, true, 2.0, 0),
        Arguments.of(BinaryOperator.INT_DIV, true, true, 1),
        Arguments.of(BinaryOperator.INT_DIV, false, 1, 0),
        Arguments.of(BinaryOperator.INT_DIV, false, 1.0, 0),
        Arguments.of(BinaryOperator.INT_DIV, false, true, 0),

        Arguments.of(BinaryOperator.MOD, true, 2, 1),
        Arguments.of(BinaryOperator.MOD, true, 2.0, 1.0),
        Arguments.of(BinaryOperator.MOD, true, true, 0),
        Arguments.of(BinaryOperator.MOD, false, 1, 0),
        Arguments.of(BinaryOperator.MOD, false, 1.0, 0.0),
        Arguments.of(BinaryOperator.MOD, false, true, 0),

        Arguments.of(BinaryOperator.POW, true, 2, 1),
        Arguments.of(BinaryOperator.POW, true, 2.0, 1.0),
        Arguments.of(BinaryOperator.POW, true, true, 1),
        Arguments.of(BinaryOperator.POW, false, 1, 0),
        Arguments.of(BinaryOperator.POW, false, 1.0, 0.0),
        Arguments.of(BinaryOperator.POW, false, true, 0),
        Arguments.of(BinaryOperator.POW, true, 0, 1),
        Arguments.of(BinaryOperator.POW, true, 0.0, 1.0),
        Arguments.of(BinaryOperator.POW, true, false, 1),
        Arguments.of(BinaryOperator.POW, false, 0, 1),
        Arguments.of(BinaryOperator.POW, false, 0.0, 1.0),
        Arguments.of(BinaryOperator.POW, false, false, 1),
        ...
        Arguments.of(BinaryOperator.EQUAL, true, 1, true),
        Arguments.of(BinaryOperator.EQUAL, false, 0, true),
        ...
        Arguments.of(BinaryOperator.NOT_EQUAL, true, 1, false),
        Arguments.of(BinaryOperator.NOT_EQUAL, false, 0, false),
        ...
        Arguments.of(BinaryOperator.GT, true, 1, false),
        Arguments.of(BinaryOperator.GT, true, 0, true),
        Arguments.of(BinaryOperator.GT, true, 1.0, false),
        Arguments.of(BinaryOperator.GT, true, 0.0, true),
        Arguments.of(BinaryOperator.GT, false, 1, false),
        Arguments.of(BinaryOperator.GT, false, 0, false),
        ...
        Arguments.of(BinaryOperator.GE, true, 1, true),
        Arguments.of(BinaryOperator.GE, true, 0, true),
        Arguments.of(BinaryOperator.GE, true, 1.0, true),
        Arguments.of(BinaryOperator.GE, true, 0.0, true),
        Arguments.of(BinaryOperator.GE, false, 1, false),
        Arguments.of(BinaryOperator.GE, false, 0, true),
        ...
        Arguments.of(BinaryOperator.LT, true, 1, false),
        Arguments.of(BinaryOperator.LT, true, 0, false),
        Arguments.of(BinaryOperator.LT, true, 1.0, false),
        Arguments.of(BinaryOperator.LT, true, 0.0, false),
        Arguments.of(BinaryOperator.LT, false, 1, true),
        Arguments.of(BinaryOperator.LT, false, 0, false),
        ...
        Arguments.of(BinaryOperator.LE, true, 1, true),
        Arguments.of(BinaryOperator.LE, true, 0, false),
        Arguments.of(BinaryOperator.LE, true, 1.0, true),
        Arguments.of(BinaryOperator.LE, true, 0.0, false),
        Arguments.of(BinaryOperator.LE, false, 1, true),
        Arguments.of(BinaryOperator.LE, false, 0, true),
  ...
  public static Stream<Arguments> provideArgsForApplyBinaryOperatorError() {
    return Stream.of(
        ...
        Arguments.of(BinaryOperator.DIV, true, 0, ArithmeticException.class),
        ...
        Arguments.of(BinaryOperator.INT_DIV, true, 0, ArithmeticException.class),
        ...
        Arguments.of(BinaryOperator.MOD, true, 0, ArithmeticException.class),
        ...
        Arguments.of(BinaryOperator.IN, true, 1, UnsupportedOperatorException.class),
        ...
        Arguments.of(BinaryOperator.NOT_IN, true, 1, UnsupportedOperatorException.class),
        ...
        Arguments.of(BinaryOperator.GET_ITEM, true, 1, UnsupportedOperatorException.class),
        ...
        Arguments.of(BinaryOperator.DEL_ITEM, true, 1, UnsupportedOperatorException.class),
  ...
  static Stream<Arguments> provideArgsForApplyTernaryOperatorError() {
    return Stream.of(
        ...
        Arguments.of(TernaryOperator.SET_ITEM, true, 1, true, UnsupportedOperatorException.class),
