...
class BinaryOperatorNodeTest extends NodeTest {
  ...
  private static Stream<Arguments> provideArgsForEvaluateValidOperands() {
    ...
    return Stream.of(
        Arguments.of(BinaryOperator.PLUS, new IntLiteralNode(1), new IntLiteralNode(1), 2L),
        ...
        Arguments.of(BinaryOperator.PLUS, new BooleanLiteralNode(true), new BooleanLiteralNode(true), 2L),
        Arguments.of(BinaryOperator.PLUS, new BooleanLiteralNode(false), new BooleanLiteralNode(false), 0L),
        Arguments.of(BinaryOperator.PLUS, new BooleanLiteralNode(true), new IntLiteralNode(1), 2L),
        Arguments.of(BinaryOperator.PLUS, new BooleanLiteralNode(false), new IntLiteralNode(1), 1L),
        Arguments.of(BinaryOperator.PLUS, new IntLiteralNode(1), new BooleanLiteralNode(true), 2L),
        Arguments.of(BinaryOperator.PLUS, new IntLiteralNode(1), new BooleanLiteralNode(false), 1L),
        ...
        Arguments.of(BinaryOperator.SUB, new IntLiteralNode(1), new IntLiteralNode(1), 0L),
        ...
        Arguments.of(BinaryOperator.SUB, new BooleanLiteralNode(true), new BooleanLiteralNode(true), 0L),
        Arguments.of(BinaryOperator.SUB, new BooleanLiteralNode(false), new BooleanLiteralNode(false), 0L),
        Arguments.of(BinaryOperator.SUB, new BooleanLiteralNode(true), new IntLiteralNode(1), 0L),
        Arguments.of(BinaryOperator.SUB, new BooleanLiteralNode(false), new IntLiteralNode(1), -1L),
        Arguments.of(BinaryOperator.SUB, new IntLiteralNode(1), new BooleanLiteralNode(true), 0L),
        Arguments.of(BinaryOperator.SUB, new IntLiteralNode(1), new BooleanLiteralNode(false), 1L),
        ...
        Arguments.of(BinaryOperator.MUL, new IntLiteralNode(2), new IntLiteralNode(2), 4L),
        ...
        Arguments.of(BinaryOperator.MUL, new BooleanLiteralNode(true), new BooleanLiteralNode(true), 1L),
        Arguments.of(BinaryOperator.MUL, new BooleanLiteralNode(false), new BooleanLiteralNode(false), 0L),
        Arguments.of(BinaryOperator.MUL, new BooleanLiteralNode(true), new IntLiteralNode(1), 1L),
        Arguments.of(BinaryOperator.MUL, new BooleanLiteralNode(false), new IntLiteralNode(1), 0L),
        Arguments.of(BinaryOperator.MUL, new IntLiteralNode(1), new BooleanLiteralNode(true), 1L),
        Arguments.of(BinaryOperator.MUL, new IntLiteralNode(1), new BooleanLiteralNode(false), 0L),
        ...
        // TODO test div by 0
        Arguments.of(BinaryOperator.INT_DIV, new IntLiteralNode(3), new IntLiteralNode(2), 1L),
        Arguments.of(BinaryOperator.INT_DIV, new FloatLiteralNode(3.0), new FloatLiteralNode(2.0), 1L),
        Arguments.of(BinaryOperator.INT_DIV, new IntLiteralNode(3), new FloatLiteralNode(2.0), 1L),
        Arguments.of(BinaryOperator.INT_DIV, new FloatLiteralNode(3.0), new IntLiteralNode(2), 1L),
        Arguments.of(BinaryOperator.INT_DIV, new BooleanLiteralNode(true), new BooleanLiteralNode(true), 1L),
        Arguments.of(BinaryOperator.INT_DIV, new BooleanLiteralNode(true), new IntLiteralNode(1), 1L),
        Arguments.of(BinaryOperator.INT_DIV, new BooleanLiteralNode(false), new IntLiteralNode(1), 0L),
        Arguments.of(BinaryOperator.INT_DIV, new IntLiteralNode(1), new BooleanLiteralNode(true), 1L),
        Arguments.of(BinaryOperator.INT_DIV, new BooleanLiteralNode(true), new FloatLiteralNode(1.0), 1L),
        Arguments.of(BinaryOperator.INT_DIV, new BooleanLiteralNode(false), new FloatLiteralNode(1.0), 0L),
        Arguments.of(BinaryOperator.INT_DIV, new FloatLiteralNode(1.0), new BooleanLiteralNode(true), 1L),
        ...
        // TODO test div by 0
        Arguments.of(BinaryOperator.MOD, new IntLiteralNode(3), new IntLiteralNode(2), 1L),
        ...
        Arguments.of(BinaryOperator.MOD, new BooleanLiteralNode(true), new BooleanLiteralNode(true), 0L),
        Arguments.of(BinaryOperator.MOD, new BooleanLiteralNode(true), new IntLiteralNode(1), 0L),
        Arguments.of(BinaryOperator.MOD, new BooleanLiteralNode(false), new IntLiteralNode(1), 0L),
        Arguments.of(BinaryOperator.MOD, new IntLiteralNode(1), new BooleanLiteralNode(true), 0L),
